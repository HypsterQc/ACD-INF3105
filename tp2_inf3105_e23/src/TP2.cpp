...
#include "../include/DocumentXML.hpp"
#include "../include/ElementXML.hpp"
#include "../include/Histoire.hpp"
...
int main( int argc, char * argv []) {
    ...
    // VOUS allez devoir changer le nom du fichier pour l'argument du main.
